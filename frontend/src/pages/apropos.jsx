export default function Apropos(){
    return(
        <div id="apropos"className="section ">
            ...
            <div>
            <p className="Text">
                J'ai, dans un premier temps, travaillé pendant plus de 10ans dans le commerce. Puis j'ai décidé de me lancer dans un domaine qui m'a toujours intéressé. <br />
                Curieux de savoir ce qui ce passé derrière les écrans, j'ai commencé à apprendre le nécessaires pour savoir coder un site web basique! <br />
